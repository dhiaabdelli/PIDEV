...
public class GoogleMapClass {
    ...
    public void configDirections( String from,String to){
        ...
        directionsService.getRoute(request, (DirectionsServiceCallback) this, new DirectionsRenderer(true, googlemapV.getMap(), directionsPane));
    ...
    public void addinitlist(){
                googlemapV.addMapInializedListener((MapComponentInitializedListener) this);
