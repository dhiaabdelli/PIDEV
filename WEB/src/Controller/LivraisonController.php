...
class LivraisonController extends AbstractController
{
    ...
    /**
     * @Route("/{idlivraison}", name="livraison_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idlivraison}/edit", name="livraison_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idlivraison}", name="livraison_delete", methods={"POST"})
     */
