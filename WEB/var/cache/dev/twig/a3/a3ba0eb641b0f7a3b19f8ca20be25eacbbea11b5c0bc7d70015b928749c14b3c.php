...
class __TwigTemplate_4ddcbb206b954d72d98f4a531ca369ae91455bc380af67704ace37feac36594c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form style=\"float: right;right: 10px;margin-top: -35px;position: absolute;\" method=\"post\" action=\"{{ path('commande_delete', {'id': commande.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ commande.id) }}\">
    <button class=\"btn bg-purple btn-flat\"><i class=\"fa fa-fw fa-trash-o\"></i> Delete</button>
</form>
", "commande/_delete_form.html.twig", "C:\\xampp\\htdocs\\pidev\\templates\\commande\\_delete_form.html.twig");
    }
}
