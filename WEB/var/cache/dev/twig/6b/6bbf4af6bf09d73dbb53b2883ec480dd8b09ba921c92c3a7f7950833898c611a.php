...
class __TwigTemplate_0b5785b74f74addc3490dfef081aa066f6d47c3e794e96f2d96230b4a73fc0f4 extends Template
{
    private $source;
    private $macros = [];
...
{% block header %}New Produit{% endblock %}

{% block breadcrumb %}New Produit{% endblock %}
{% block body %}
    <div class=\"box\">
        <div class=\"box-header with-border\">
            <h3 class=\"box-title\">Ajouter un Produit</h3>
...
{% endblock %}
", "produit/new.html.twig", "C:\\xampp\\htdocs\\pidev\\templates\\produit\\new.html.twig");
    }
}
