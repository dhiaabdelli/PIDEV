...
class __TwigTemplate_b6eae513685d0ee4d6d4066bea61cfde85a75026a8994bcb8cfe392caf69ab9a extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("back.html.twig", "categorie/show.html.twig", 1);
            ...
            <table style=\"margin-bottom: 15px;\" class=\"table\">
                <tbody>
                    <tr>
                        ...
                        <td>";
        // line 21
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 21, $this->source); })()), "id", [], "any", false, false, false, 21), "html", null, true);
        echo "</td>
                    </tr>
                    <tr>
                        <th>Nom</th>
                        <td>";
        // line 25
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 25, $this->source); })()), "nom", [], "any", false, false, false, 25), "html", null, true);
        echo "</td>
                    </tr>
                    <tr>
                        <th>Description</th>
                        <td>";
        // line 29
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 29, $this->source); })()), "description", [], "any", false, false, false, 29), "html", null, true);
        echo "</td>
                    </tr>
                </tbody>
            </table>
...
";
    ...
    {
        return array (  173 => 38,  168 => 36,  163 => 34,  155 => 29,  148 => 25,  141 => 21,  128 => 10,  118 => 9,  99 => 7,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% block body %}
    <div class=\"box\">
        ...
        <div class=\"box-body\">
            ...
            <a class=\"btn bg-purple btn-flat\" href=\"{{ path('categorie_edit', {'id': categorie.id}) }}\"><i class=\"fa fa-edit\"></i> edit</a>
...
{% endblock %}
", "categorie/show.html.twig", "C:\\xampp\\htdocs\\pidev\\templates\\categorie\\show.html.twig");
    }
}
