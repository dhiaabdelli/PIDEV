...
public class ViewProduit extends BaseForm {
    ...
    public ViewProduit(com.codename1.ui.util.Resources resourceObjectInstance) {
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        listproduit = ProduitService.getInstance().getList();
        ...
        for (int i = 0; i < listproduit.size(); i++) {
            ...
            gui_Multi_Button_1.setPropertyValue("line1", listproduit.get(i).getLibelle());
            gui_Multi_Button_1.setPropertyValue("line2", listproduit.get(i).getDescription());
            gui_Multi_Button_1.setPropertyValue("uiid1", "Label");
            gui_Multi_Button_1.setPropertyValue("uiid2", "RedLabel");
            gui_LA.setUIID("Label");
            gui_LA.setName("LA");
            gui_LA.setPropertyValue("line1", String.valueOf(listproduit.get(i).getPrix()+" DT"));
            gui_LA.setPropertyValue("line2", String.valueOf(listproduit.get(i).getRating()+"/5"));
